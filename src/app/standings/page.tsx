...
/**
 * Standings — port of legacy/standings.html.
 *
...
export default function StandingsPage() {
  const { data, loading, error } = useApi<any>('/api/standings');
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 pb-12">
      <PageHeader
        title={data?.leagueName ?? 'League Standings'}
        subtitle={
          <>
            League Standings
            <span className="block text-xs text-faint">Click any manager for profile stats.</span>
          </>
        }
      />
