 ...
 */
function didNotPlay(player, gwHasStarted) {
 ...
 * @param {Array} players - Player objects with isCaptain, isViceCaptain,
 *   multiplier, subOut, and (optionally) minutes/allFixturesStarted/hasNoGame
 * @param {boolean} gwHasStarted - Whether any fixture in the GW has kicked off
 */
function resolveEffectiveCaptaincy(players, gwHasStarted = false) {
